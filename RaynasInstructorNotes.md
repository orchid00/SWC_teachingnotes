...
This is the script I use when teaching workshop.
...
1. As the instructor, what should you do if most of the class votes for one of the wrong answers?  2. For the right answer?  3. What if the votes are evenly spread between options?
